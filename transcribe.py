...
result = model.transcribe(
    r"C:\MY_BACKUP\LearningStuff\Polish\A1_2\Recordings\Lecture20_3rdSept\Lecture20_3rdSept.mp3",
    task="transcribe",
...
output_file_path = r"Lectures/Polish/A1_2/L20_3rdSept/L20_3rdSept.txt"
