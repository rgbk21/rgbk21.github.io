...
result = model.transcribe(
    r"C:\MY_BACKUP\LearningStuff\Polish\A1_2\Recordings\Lecture21_8thSept\Lecture21_8thSept.mp3",
    task="transcribe",
...
output_file_path = r"Lectures/Polish/A1_2/L21_8thSept/L21_8thSept.txt"
