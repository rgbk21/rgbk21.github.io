...
result = model.transcribe(
    r"C:\MY_BACKUP\LearningStuff\Polish\A1_2\Recordings\Lecture12_4thAugust\Lecture12_4thAugust.mp3",
    task="transcribe",
...
output_file_path = r"Lectures/Polish/A1_2/L12_4thAugust/L12_4thAugust.txt"
